...
namespace MarvinsAIRA
{
	...
	{
		public const float Version = 0.65f; //this is the current version of the app
        //this could do with getting automatically added from the assembly info, or been automaticly set to the xaml title to save of duplication

        private const string webpageUrl = "https://herboldracing.com/marvins-awesome-iracing-app-maira/previous-versions/"; //webpage to check for updates
        ...
        public async void DownloadUpdate(MainWindow window) //download update
        {
        ...
        {
            if (!_downloadedUpdate) //if no update dont do anything
                return;
