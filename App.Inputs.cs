		...
		public void UpdateInputs()
		{
			...
			foreach ( var joystick in _input_joystickList )
			{
				try
				{
                    ...
                    if (!_lastStatJoystickUpdate.ContainsKey(joystick.Information.InstanceGuid))
                        _lastStatJoystickUpdate.Add(joystick.Information.InstanceGuid, joystickUpdateArray);
                    else
                        _lastStatJoystickUpdate[joystick.Information.InstanceGuid] = joystickUpdateArray;
                }
				catch ( Exception )
				{
					joystick.Acquire();
